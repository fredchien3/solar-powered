...
ApplicationRecord.transaction do
  ...
  puts "Creating games..."
  fallout4 = Game.create!( # Fallout 4
    name: 'fallout4',
    title: 'Fallout 4',
    price: 59.99,
  ...
  spaceengineers = Game.create!( # Space Engineers
    name: 'spaceengineers',
  ...
  projectzomboid = Game.create!( # Project Zomboid
    name: 'projectzomboid',
  ...
  Review.create!(author: ford, game: fallout4, recommended: true, body: "I love this game! There's nothing better than stomping around in Power Armor and blasting some wasteland creatures. I also really liked the settlement building.")
  ...
  Review.create!(author: ford, game: spaceengineers, recommended: true, body: "This game really makes you feel like a space engineer. You can think of it like Minecraft, but in space, and with a lot more complexity. It's super fun!")
  Review.create!(author: ford, game: projectzomboid, recommended: true, body: "PZ is super fun, and don't let the graphics fool you - it can get really intense. The sound design really ramps up the apocalyptic zombie feeling, and the long-waited animation update really changed the game for the better.")
